...
!(function () {
  ...
  (e.parcelPointLinks = {
    ...
    initMap: function () {
      ...
      i.setAttribute(
        "src",
        `${baseurl}/wp-content/plugins/Vignoblexport/Vignoblexport/VignoblexportConnectWoocommerce/assets/img/vignoblexport.png`
      );
      ...
      return new Promise(function (t, n) {
        ...
        if (carrierName == "ups") {
          xhr.open(
            "POST",
            baseurl +
              "/wp-content/plugins/Vignoblexport/Vignoblexport/VignoblexportPhp/getRelayPoints.php"
          );
          xhr.send(data);
        } else {
          xhr.open(
            "POST",
            baseurl +
              "/wp-content/plugins/Vignoblexport/Vignoblexport/VignoblexportPhp/getChronoRelayPoints.php"
          );
          xhr.send(dataChrono);
        }
      });
