 ...
 *
 * @package     HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Shipping_Method
 */

namespace HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Shipping_Method;
 ...
 * Controller class.
 *
 * Handles additional methods for the Hillebrand Gori eShipping method.
 *
 * @class       Controller
 * @package     HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Shipping_Method
 * @category    Class
...
class Controller
{
	...
	public function __construct($plugin)
	{
		...
		$this->ajax_nonce     = wp_create_nonce('HillebrandGoriEshipping_woocommerce_shipping_method');
	}
	...
	public function shipping_method_scripts()
	{
		...
		wp_enqueue_script('VINW_tail_select', $this->plugin_url . 'HillebrandGoriEshipping/HillebrandGoriEshippingConnectWoocommerce/assets/js/tail.select-full.min.js', array('VINW_polyfills'), $this->plugin_version);
		wp_enqueue_script('VINW_shipping_method', $this->plugin_url . 'HillebrandGoriEshipping/HillebrandGoriEshippingConnectWoocommerce/assets/js/shipping-method.min.js', array('VINW_tail_select', 'VINW_polyfills'), $this->plugin_version);
	...
	public function shipping_method_styles()
	{
		...
		wp_enqueue_style('VINW_shipping_method', $this->plugin_url . 'HillebrandGoriEshipping/HillebrandGoriEshippingConnectWoocommerce/assets/css/shipping-method.css', array(), $this->plugin_version);
	}
	...
	{
		check_ajax_referer('HillebrandGoriEshipping_woocommerce_shipping_method', 'security');
		...
		$parcel_point_networks = \HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Shipping_Method\Parcel_Point\Controller::get_network_list();
