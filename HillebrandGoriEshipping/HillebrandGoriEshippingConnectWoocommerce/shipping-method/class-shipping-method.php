...
use HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Util\Cart_Util;
 ...
 *
 * Add a Hillebrand Gori eShipping shipping method to WooCommerce.
 *
...
class Shipping_Method extends \WC_Shipping_Method
{
	...
	{
		$this->id                 = 'HillebrandGoriEshipping_connect';
		$this->instance_id        = absint($instance_id);
		$this->method_title       = __('Hillebrand Gori eShipping', 'HillebrandGoriEshipping');
		$this->method_description = __('Lets you define weight/price ranges of your shipping costs for each of your delivery methods and add a pickup point map.', 'HillebrandGoriEshipping');
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
		);
	...
	public function init_form_fields()
	{
		return array(
			'title' => array(
				'title'       => __('Method title', 'HillebrandGoriEshipping'),
				'type'        => 'text',
				'description' => __('This controls the title which the user sees during checkout.', 'HillebrandGoriEshipping'),
				'default'     => __('Flat rate Hillebrand Gori eShipping', 'HillebrandGoriEshipping'),
				'desc_tip'    => true,
			),
			'rates'      => array(
				'type' => 'rates_table',
	...
	{
		$pricing_items         = \HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Shipping_Method\Controller::get_pricing_items(
