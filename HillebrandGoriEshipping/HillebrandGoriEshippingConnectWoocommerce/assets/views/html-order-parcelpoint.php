...
$weekday_initials = array(
	'MONDAY'    => substr(__('MONDAY', 'HillebrandGoriEshipping'), 0, 1),
	'TUESDAY'   => substr(__('TUESDAY', 'HillebrandGoriEshipping'), 0, 1),
	'WEDNESDAY' => substr(__('WEDNESDAY', 'HillebrandGoriEshipping'), 0, 1),
	'THURSDAY'  => substr(__('THURSDAY', 'HillebrandGoriEshipping'), 0, 1),
	'FRIDAY'    => substr(__('FRIDAY', 'HillebrandGoriEshipping'), 0, 1),
	'SATURDAY'  => substr(__('SATURDAY', 'HillebrandGoriEshipping'), 0, 1),
	'SUNDAY'    => substr(__('SUNDAY', 'HillebrandGoriEshipping'), 0, 1),
);
...
if ($has_address) {
?>
	<h4><?php echo esc_html(__('Pickup point adress', 'HillebrandGoriEshipping')); ?></h4>
	<p>
...
if (true == false) {
?>
	<h4><?php echo esc_html(__('Opening hours', 'HillebrandGoriEshipping')); ?></h4>
