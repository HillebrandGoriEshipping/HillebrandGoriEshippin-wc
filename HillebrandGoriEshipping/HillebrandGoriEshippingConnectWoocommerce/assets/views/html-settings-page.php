...
<div class="wrap" id="VINW-connect">
	...
	<form method="post" action="options.php">
		...
		<?php submit_button($text = __("Save", 'HillebrandGoriEshipping'), $type = 'primary', $name = 'submitkey'); ?>
	</form>
...
<?php if (get_option('VINW_ACCESS_KEY')  && get_option("acces-key-validate") == "1") { ?>
	<div class="wrap" id="VINW-settings">
		...
		<h2><?php esc_html_e('Address used to calculate shipping charges', 'HillebrandGoriEshipping') ?></h2>
		<p><?php esc_html_e('Contact our support if you need to edit those informations', 'HillebrandGoriEshipping') ?></p>
		<table class="form-table states">
			<tr valign="top">
			...
			<table class="form-table states">
				...
				<tr valign="top">
					...
					<td>
						...
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('Set the minimum number of bottles needed to activate the Hillebrand Gori eShipping shipping option on the checkout page', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				...
				<!-- PREPARATION TIME -->
				<tr valign="top">
					<th scope="row"><?php esc_html_e('Preparation time', 'HillebrandGoriEshipping'); ?> :
					</th>
					<td>
						...
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('Set the minimum number of days needed to prepare the parcels and make them ready for pickup', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				</tr>
				...
				<tr valign="top">
					...
					<td>
						...
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('Displays the duties and taxes estimation on the checkout page if you choose the "At the recipient\'s expense" option (domestic international shipments)', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				</tr>
				...
				<!-- VAT CHOICE -->
				<tr valign="top">
					<th scope="row"><?php esc_html_e('Apply VAT', 'HillebrandGoriEshipping'); ?> :</th>
					<td>
						<select id="form_trans" name="VINW_VAT_CHOICE" class="form-control" style="min-width: 250px;">
							<?php if (get_option('VINW_VAT_CHOICE')) { ?>
								<option value="yes" <?php if (get_option('VINW_VAT_CHOICE') == 'yes') echo 'selected' ?>><?php esc_html_e('Yes', 'HillebrandGoriEshipping') ?></option>
								<option value="no" <?php if (get_option('VINW_VAT_CHOICE') == 'no') echo 'selected' ?>><?php esc_html_e('No', 'HillebrandGoriEshipping') ?></option>
							<?php	} else { ?>
						...
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('Choose if you want to apply VAT to carrier prices (does not affect product prices)', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				</tr>
			</table>

			<h2><?php esc_html_e('Numbers & Registrations', 'HillebrandGoriEshipping') ?></h2>
			<table class="form-table states">
				<!-- VAT NUMBER -->
				<tr valign="top">
					<th scope="row"><?php esc_html_e('VAT number', 'HillebrandGoriEshipping'); ?> :</th>
					<td>
						...
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('Enter your VAT number (required)', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				</tr>
				...
				<tr valign="top">
					...
					<td>
						<select name="VINW_ASSURANCE">
							<option value="no" <?php if (get_option('VINW_ASSURANCE') == 'no') echo 'selected' ?>><?php esc_html_e('No', 'HillebrandGoriEshipping') ?></option>
							<option value="yes" <?php if (get_option('VINW_ASSURANCE') == 'yes') echo 'selected' ?>><?php esc_html_e('Yes', 'HillebrandGoriEshipping') ?></option>
						</select>
						<div class="tooltip">?
							<span class="tooltiptext"><?php esc_html_e('If you choose "Yes", all shipments will be insured with a minimum amount of 5 € (may vary depending on the total price of the products)', 'HillebrandGoriEshipping'); ?></span>
						</div>
					</td>
				</tr>
			</table>
