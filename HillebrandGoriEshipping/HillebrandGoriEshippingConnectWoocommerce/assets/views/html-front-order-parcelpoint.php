...
?>
<?php if (isset($status)) : ?>
  <h2><?php esc_html_e('Status: ', 'HillebrandGoriEshipping'); ?></h2>
  <p><span class="CalendarDay__hovered_span"><?php echo  $status ?></span></p>
<?php endif; ?>
<?php if (isset($trackingLink)) : ?>
  <h2><?php esc_html_e('Track your order:', 'HillebrandGoriEshipping'); ?></h2>
  <p><a href="<?php echo  $trackingLink ?>" target="_blank"><?php esc_html_e('Click here to track the status of your order', 'HillebrandGoriEshipping'); ?></a> </p>
<?php endif; ?>
<?php if (isset($trackingCode)) : ?>
  <h2><?php esc_html_e('Track your order:', 'HillebrandGoriEshipping'); ?></h2>
  <p><a href="<?php echo  $trackingCode ?>" target="_blank"><?php esc_html_e('Click here to track the status of your order', 'HillebrandGoriEshipping'); ?></a> </p>
<?php endif; ?>
<div class="VINW-order-parcelpoint">
  <h2><?php esc_html_e('Chosen pickup point', 'HillebrandGoriEshipping'); ?></h2>
  <?php
