...
?>
<p><strong><?php esc_html_e('Status :', 'HillebrandGoriEshipping'); ?></strong>
...
<?php if (isset($trackingLink)) { ?>
  <p><strong><?php esc_html_e('Track your order :', 'HillebrandGoriEshipping'); ?></strong> <a href="<?php echo  $trackingLink ?>" target="_blank"><?php esc_html_e('Click here', 'HillebrandGoriEshipping'); ?></a> </p>
<?php } ?>
<?php if (isset($trackingCode)) { ?>
  <p><strong><?php esc_html_e('Tracking code(s) :', 'HillebrandGoriEshipping'); ?></strong>
  <p><?php echo  str_replace(';', '<br>', $trackingCode) ?></p>
<?php } ?>

<?php if (array_key_exists("directLink", json_decode($response, true))) { ?>
  <p><strong><?php esc_html_e('Download labels :', 'HillebrandGoriEshipping'); ?></strong> <a href="<?php echo  $labelLink ?>" target="_blank"><?php esc_html_e('Click here', 'HillebrandGoriEshipping'); ?></a> </p>
<?php } ?>