  ...
  function getSizesPack(nbBottles, nbMagnums, nbPack) {
    ...
    jQuery.ajax({
      ...
      url:
        location.origin +
        baseurl +
        "wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/get_pack.php?nbBottles=" +
        nbBottles +
        "&nbMagnums=" +
        nbMagnums +
        "&nbPack=" +
...
function updatstatusPallet() {
  ...
  jQuery.ajax({
    ...
    url:
      location.origin +
      baseurl +
      "wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/updatestatusPalletexpidition.php?order_id=" +
      order_id,
...
function updatstatus() {
  ...
  jQuery.ajax({
    ...
    url:
      location.origin +
      baseurl +
      "wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/updatestatusexpidition.php?order_id=" +
      order_id,
    success: function (xml, textStatus, xhr) {
...
function updatparm() {
  ...
  jQuery.get(
    location.origin +
      baseurl +
      "wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/expedition_param_update.php?order_id=" +
      order_id +
      "&offer=" +
      offer +
      "&offerIndex=" +
