...
(function ($) {
  ...
  function updatcolis() {
    ...
    $.get(
      baseurl +
        "/wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/updatecolis.php?choix=" +
        choixcolis +
        "&choixIndex=" +
        choixIndexcolis,
      function (data) {
        $.get(
          baseurl +
            "/wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/get-colis.php",
          function (data) {
  ...
  function updatcart() {
    ...
    $.get(
      baseurl +
        "/wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/updateexpidition.php?methode=" +
        methode +
        "&methodIndex=" +
        methodeIndex +
        "&offer=" +
      ...
      function (data) {
        $.get(
          baseurl +
            "/wp-content/plugins/HillebrandGoriEshipping/HillebrandGoriEshipping/HillebrandGoriEshippingPhp/get-expidition.php",
          function (data) {
