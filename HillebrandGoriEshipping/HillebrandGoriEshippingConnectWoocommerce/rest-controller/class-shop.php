...
use HillebrandGoriEshipping\HillebrandGoriEshippingConnectWoocommerce\Util\Configuration_Report_Util;
...
class Shop
{
	...
	public function pairing_handler($request)
	{
		...
		$callback_url = null;
		$settings_url = admin_url('admin.php?page=HillebrandGoriEshipping-settings');
