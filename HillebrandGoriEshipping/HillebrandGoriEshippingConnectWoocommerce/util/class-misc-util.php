...
class Misc_Util
{
	...
	public static function get_active_parcel_point_networks($settings)
	{
		...
		if (! isset($settings['VINW_parcel_point_networks']) || null === $settings['VINW_parcel_point_networks'] || ! is_array($settings['VINW_parcel_point_networks']) || empty($settings['VINW_parcel_point_networks'])) {
			return array();
		}
		...
		return array_intersect($networks_array, $settings['VINW_parcel_point_networks']);
	}
